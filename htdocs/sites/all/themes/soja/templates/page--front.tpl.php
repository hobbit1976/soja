<div id="page" class="container-front">

  <?php print render($page['leaderboard']); ?>

  <header class="clearfix front" role="banner">
  ...
  <div id="columns-front"><div class="columns-inner clearfix">
    <div id="content-column"><div class="content-inner">
      ...
      <<?php print $tag; ?> id="main-content" role="main">
        ...
        <div id="content-front"><?php print render($page['content']); ?></div>
